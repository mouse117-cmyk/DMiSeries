...
You can test a batch of time series data over a period of time like this. The first parameter will not be used in this case; you only need to focus on the fourth parameter. If the fourth parameter is not provided, the default value will be used.

```
$ ./DMiSeries_test <row_count> <times> <num_q> <num_series> --gtest_filter=AlgorithmTest.TestDevops100000
```
...
- [num_series] number of time series inserted

Example

```
$ ./DMiSeries_test 100000 100000 10 100000 --gtest_filter=AlgorithmTest.TestDevops100000
```
...
HashKV: [https://github.com/LSMdb/HashKV](https://github.com/LSMdb/HashKV)
