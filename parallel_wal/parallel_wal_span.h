#ifndef TEMPUSCSTORE_PARALLEL_WAL_SPAN_H
#define TEMPUSCSTORE_PARALLEL_WAL_SPAN_H
...
namespace tsdb {
    namespace parallel_wal {
        ...
        class PWalManagementSpan {

            class Wal {
            public:
                Wal(tsdb::head::SpanHead* head, const std::string& dir = "", int seq = 0, bool tag_log = false);
                ~Wal();
        ...
        public:
            PWalManagementSpan(tsdb::head::SpanHead* head, const int &wal_num, const std::string &dir);
...
#endif //TEMPUSCSTORE_PARALLEL_WAL_SPAN_H
