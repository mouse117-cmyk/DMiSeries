...
// Helper class for test to unify the interface between
...
class Harness : public testing::Test {
 public:
  ...
  void Init(const TestArgs& args) {
    ...
    // Use shorter block size for test to exercise block boundary
    // conditions more.
...
TEST(TableTest, ApproximateOffsetOfCompressed) {
  if (!SnappyCompressionSupported()) {
    std::fprintf(stderr, "skipping compression test\n");
    return;
  }
