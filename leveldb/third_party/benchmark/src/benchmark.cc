...
// considered significant.  For cpu-time based test, this is the lower bound
// on the total cpu time used by all threads that make up the test.  For
// real-time based test, this is the lower bound on the elapsed time of the
...
#endif
  // Offset test to ensure commonly accessed data is on the first cache line.
