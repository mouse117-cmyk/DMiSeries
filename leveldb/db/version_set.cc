...
//        DeCodeKey(files_[level][i]->largest.user_key().ToString(), max_sgid, max_mid, maxt);
        ...
        slab::decode_l1key(files_[level][i]->smallest.user_key().ToString(), min_sgid, min_mid, mint);
        slab::decode_l1key(files_[level][i]->largest.user_key().ToString(), max_sgid, max_mid, maxt);
